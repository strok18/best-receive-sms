function init(){localStorage.getItem("brsPrivacy")||document.getElementById("privacy_alert").classList.remove("d-none");let e=[].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'));e.map(function(e){return new bootstrap.Tooltip(e)});let t=window.location.pathname.substring(1);if(1<t.length)try{document.getElementById(t).classList.add("active");let e=document.getElementById("countries");(-1!=t.indexOf("-phone-number")&&"upcoming-phone-number"!==t||"country"===t)&&e.classList.add("active")}catch(e){try{let e=/receive-sms-from-([a-zA-Z]+)/;var o=e.exec(t);document.getElementById(o[1]+"-phone-number").classList.add("active"),document.getElementById("countries").classList.add("active")}catch(e){}}}function stretchBottom(){var e=screen.availHeight;let t=document.getElementById("foot-null");e=e-t.offsetTop-232;0<e&&(t.style.height=e+"px")}function unload(){window.addEventListener("unload",function(e){console.log(1)})}function clickLoading(){let e=document.getElementsByClassName("click_loading");for(var t in e)e[t].onclick=function(){loading(!0,5)}}function scrollTop(){window.onscroll=function(e){let t=document.getElementById("top");document.documentElement.scrollTop>.1*document.body.clientHeight?t.classList.remove("d-none"):t.classList.add("d-none")}}function toast(e,t={}){void 0===t.type&&(t.type="success"),void 0===t.title&&(t.title="MESSAGE"),void 0===t.isClose&&(t.isClose=!0),void 0===t.showTime&&(t.showTime=5e3);let o=Math.floor(99999*Math.random());e='<div id="toast'+o+'" class="toast bg-'+t.type+' text-light m-1" aria-atomic="true" data-bs-autohide="'+t.isClose+'" data-bs-delay="'+t.showTime+`" style="width:450px;">
	...
	`,{title:e.title,size:"",autoClose:!1},function(e){inputFocus("form_feedback");let t=e;loadScript(function(){$("#email_address").val();$.ajax({url:"/api/feedback",type:"post",data:{content:$("#feedback_content").val(),email:$("#feedback_email").val(),type:1},beforeSend:function(){$("#confirm").attr("disabled","disabled"),$("#confirm_loading").removeClass("d-none")},success:function(e){0==e.error_code?(toast(e.msg),modalClose(t)):toast(e.msg,{type:"danger"})},complete:function(){$("#confirm").removeAttr("disabled"),$("#confirm_loading").addClass("d-none")}})})},function(e){})}function buttonLoading(e,t=!0){let o=document.getElementById(e);!0===t?o.classList.remove("d-none"):o.classList.add("d-none")}function loadScript(e,t){var o={jquery:"//"+window.location.host+"/static/web/js/jquery-3.6.0.min.js",copy:"//"+window.location.host+"/static/web/js/clipboard.min.js",recaptcha:"https://recaptcha.net/recaptcha/api.js?render=6Lf71VQcAAAAAG1lsIdsb3aeTivSf_rkKUKaCu7V"};t=void 0===t?o.jquery:o[t];let n=document.createElement("script");n.type="text/javascript",n.readyState?n.onreadystatechange=function(){"loaded"!=n.readyState&&"complete"!=n.readyState||(n.onreadystatechange=null,e())}:n.onload=function(){e()},n.src=t,document.getElementsByTagName("head")[0].appendChild(n)}function inputFocus(e="form_data"){let t=document.getElementById(e);t.classList.add("was-validated")}window.onload=function(){init(),scrollTop(),clickLoading(),unload(),stretchBottom(),"function"==typeof copyPhone&&copyPhone(),"function"==typeof messageInit&&messageInit()};